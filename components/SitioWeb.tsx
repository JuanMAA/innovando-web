...
export default function SitioWeb({ business, photoRefs, reviews }: Props) {
      ...
      <div className="relative h-[70vh] min-h-[420px] overflow-hidden">
        ...
        <div className="absolute bottom-0 left-0 right-0 px-6 pb-10">
          <div className="mx-auto max-w-6xl">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-white leading-tight drop-shadow-lg mb-3">
              {business.name}
            </h1>
              ...
              <div className="flex flex-col gap-3">
                {business.phone && (
                  <a
                    ...
                    className="inline-flex items-center gap-3 rounded-xl border border-gray-200 bg-white px-4 py-3.5 text-sm font-semibold text-gray-800 hover:bg-gray-50 transition-colors"
                  >
                ...
                {business.whatsapp && (
                  <a
                    ...
                    className="inline-flex items-center gap-3 rounded-xl bg-green-500 px-4 py-3.5 text-sm font-semibold text-white hover:bg-green-600 transition-colors"
                  >
                ...
                <a
                  ...
                  className="inline-flex items-center justify-center gap-2 rounded-xl bg-gray-900 px-4 py-3.5 text-sm font-bold text-white hover:bg-gray-800 transition-colors"
                >
                  Hacer una reserva
