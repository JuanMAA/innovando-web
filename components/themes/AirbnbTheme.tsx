...
export default function AirbnbTheme({ business, photoRefs, reviews }: Props) {
    ...
    <div className="min-h-screen bg-white font-sans">
      ...
      <header className="sticky top-0 z-50 bg-white border-b border-gray-200">
        <div className="mx-auto max-w-7xl px-6 py-4 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-6 text-sm font-medium text-gray-700">
            <a href="#" className="hover:text-gray-900 border-b-2 border-gray-900 pb-0.5">Alojamientos</a>
            <a href="#" className="hover:text-gray-900">Experiencias</a>
          </nav>
            ...
            <div className="flex items-center gap-2 mt-1 text-sm text-gray-700">
              {business.rating && (
                <>
                  ...
                  <span className="underline font-medium cursor-pointer">{business.num_reviews} reseñas</span>
                  <span className="text-gray-400">·</span>
                </>
              )}
            ...
            {reviews.length > 0 && (
              <div className="py-8">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <span className="text-xl font-semibold">{business.num_reviews} reseñas</span>
                </div>
          ...
          <div className="hidden lg:block">
            <div className="sticky top-28 border border-gray-200 rounded-2xl p-6 shadow-xl">
              <div className="flex items-baseline gap-1 mb-1">
                <span className="text-xl font-bold text-gray-900">Contactar</span>
              </div>
              {business.rating && (
              ...
              <p className="text-center text-xs text-gray-400 mt-4">No se realizará ningún cargo por ahora</p>
            </div>
          </div>
        </div>
      </main>
      ...
      <div className="fixed bottom-0 left-0 right-0 lg:hidden bg-white border-t border-gray-200 px-6 py-4 flex items-center justify-between">
        <div className="text-sm">
          <span className="font-bold text-gray-900">Reservar</span>
